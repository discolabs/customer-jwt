defmodule CustomerJwt.RouterTest do
  ...
  test "token endpoint returns expected jwt when shop, customer, timestamp and valid signature provided" do
    ...
    assert conn.resp_body == "{% layout none %}{% if customer.id == 3041789640759 %}eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Nf59mhgjyO2G9VPPiKm6risGZg7uTfsziUSCmOU0VSg{% endif %}"
  end
